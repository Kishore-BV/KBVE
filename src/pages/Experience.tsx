...
const experienceData = [
  {
    ...
    type: "Full-time",
    description: "Leading research and development initiatives in drone technology and automation systems. Developing innovative solutions for smart automation and robotics applications.",
  ...
  },
  {
    ...
    type: "Internship",
    description: "Worked on cutting-edge robotics projects, focusing on machine learning integration and autonomous systems development.",
          ...
          >
            ...
            <motion.div variants={itemVariants} className="text-center space-y-4">
              <h1 className="text-4xl lg:text-6xl font-bold">
                <span className="text-transparent bg-clip-text bg-gradient-primary">Experience</span>
              </h1>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                My professional journey in automation, robotics, and R&D innovation
              </p>
            </motion.div>
